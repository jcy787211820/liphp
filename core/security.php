...
class Security
{
	...
	public function __construct()
	{
		...
		{
			$_REQUEST[$key]	= $this->xssClean( $value );
		}
	}
	 ...
	 * @return	string
	 */
	public function xssClean( $str, $trim = TRUE, $is_image = FALSE )
	{
		/*
	 ...
	 */
	private function _removeEvilAttributes($str, $is_image)
	{
	 ...
	 * @return	string
	 */
	private function _decodeEntity($match , $charset='UTF-8')
	{
		return $this->_entityDecode($match[0], $charset );
	}
	...
	private function _validateEntities( $str )
	{
		...
		$str = preg_replace('|\&([a-z\_0-9\-]+)\=([a-z\_0-9\-]+)|i', $this->_getXssHash()."\\1=\\2", $str );
		 ...
		 */
		$str = str_replace($this->_getXssHash(), '&', $str );
